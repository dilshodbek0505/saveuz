...
from apps.main.admin.banner import BannerAdmin
from apps.main.admin.category import CategoryAdmin
from apps.main.admin.subcategory import SubcategoryAdmin
